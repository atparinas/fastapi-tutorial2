...
from app.core.config import DATABASE_URL, DATABASE_DB  # noqa
...
def run_migrations_online() -> None:
    ...
    if os.environ.get("TESTING"):
        ...
        with default_engine.connect() as default_conn:
            default_conn.execute(f"DROP DATABASE IF EXISTS {DATABASE_DB}_test")
            default_conn.execute(f"CREATE DATABASE {DATABASE_DB}_test")
